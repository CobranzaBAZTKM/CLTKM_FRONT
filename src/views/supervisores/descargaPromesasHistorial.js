...
export default class DescargaPromesasHistorial extends React.Component{
    ...
    render(){
        return(
            <div>
                <DescargaHistorialPromesas/>
            </div>
        )
    }
}

const DescargaHistorialPromesas=()=>{
    ...
    const handleClickDescargaPromesas=()=>{
        handleOpenCargando();
        if(tipoCartera!==null){
            servicio.consumirServiciosGET("service/carteraLocal/consultarCarteraPromesaHistorico/"+tipoCartera).then(
            ...
            <Grid container spacing={1}>
                <Grid item xl={12} lg={12} md={12} sm={12} style={{textAlign:'center'}}>
                    <h1 style={{
                        ...
                        Descargar Historial de Promesas
                    </h1>
                </Grid>
            </Grid>
            <br/>
